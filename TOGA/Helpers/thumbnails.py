...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4.text((670, 150), "NOW PLAYING", fill="grey", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
...
async def gen_qthumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "TOGA MUSIC", fill="black", font = font1, align ="left")
            image4.text((670, 150), "ADDED TO QUEUE", fill="grey", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
